...
public class ServletInvocableHandlerMethod extends InvocableHandlerMethod {
	...
	private class ConcurrentResultHandlerMethod extends ServletInvocableHandlerMethod {
		...
		public ConcurrentResultHandlerMethod(final Object result, ConcurrentResultMethodParameter returnType) {
			super((Callable<Object>) () -> {
				...
				} else if (result instanceof Throwable) { throw new NestedServletException("Async processing failed", (Throwable) result); }
				return result;
			}, CALLABLE_METHOD);
	...
	private class ConcurrentResultMethodParameter extends HandlerMethodParameter {
		...
		public ConcurrentResultMethodParameter(Object returnValue) {
			...
			this.returnType = (returnValue instanceof ReactiveTypeHandler.CollectedValuesList ? ((ReactiveTypeHandler.CollectedValuesList) returnValue).getReturnType() : KotlinDetector.isSuspendingFunction(super.getMethod()) ? ResolvableType.forMethodParameter(getReturnType()) : ResolvableType.forType(super.getGenericParameterType()).getGeneric());
		}
		...
		public Class<?> getParameterType() {
			if (this.returnValue != null) { return this.returnValue.getClass(); }
			if (!ResolvableType.NONE.equals(this.returnType)) { return this.returnType.toClass(); }
